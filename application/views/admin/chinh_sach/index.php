		...
		<table cellpadding="0" cellspacing="0" width="100%" class="sTable mTable myTable withCheck" id="checkAll">
			...
			<tbody>
				...
				<tr>
					...
					<td>
						<span title="<?php echo $row->link?>" class="tipS">
							<?php echo $row->link?>
						</span>
					</td>
					<td>
					...
					<td class="option">
						<a href="<?php echo admin_url('chinh_sach/edit/'.$row->id)?>" title="Chỉnh sửa" class="tipS ">
						   <img src="<?php echo public_url('admin')?>/images/icons/color/edit.png" />
						</a>
						<a href="<?php echo admin_url('chinh_sach/delete/'.$row->id)?>" title="Xóa" class="tipS verify_action" >
