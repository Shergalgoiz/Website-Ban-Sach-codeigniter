				...
				<div class="tab_container">
					<div class="tab_content pd0" id="tab1" style="display: block;">
						...
						<div class="formRow">
							...
							<div class="formRight">
								<input type="text" name="vi_tri" value="<?php echo $ads->vi_tri?>" />
							</div>
							<div class="clear"></div>
						</div>
						...
						<div class="formRow">
							...
							<div class="formRight">
							    <div class="left">
							        <input type="text" name="image" id="image" value="<?php echo $ads->image_link ?>" size="50">
							        <?php if($ads->image_link != ''): ?>
							        <img src="<?php echo $ads->image_link ?>" width="100px" alt=""  style="display: block">
							        <?php endif ?>
							    </div>
						...
						<div class="formRow">
							...
							<div class="formRight">
								<span class="oneTwo">
								<input type="text" _autocheck="true" id="param_href" name="href" value="<?php echo $ads->href?>">
								</span>
								<span class="autocheck" name="name_autocheck"></span>
								<div class="clear error" name="name_error"><?php echo form_error('href')?></div>
							</div>
							<div class="clear"></div>
						</div>
