...
<div class="wrapper">
      ...
      <form id="form" class="form" enctype="multipart/form-data" method="post" action="">
          <fieldset>
                ...
                <div class="formRight">
                  <span class="oneTwo"><input type="text" value="<?php echo !empty($info->slug) ? $info->slug : '' ; ?>" _autocheck="true" id="param_name" name="slug"></span>
                ...
                <div class="formRow">
                  ...
                  <div class="formRight">
                    <span class="oneTwo">
                    <textarea cols="" rows="4" _autocheck="true" id="param_meta_desc" name="meta_desc"><?php echo !empty($info->meta_desc) ? $info->meta_desc : ''?></textarea></span>
            ...
            <div class="formRow">
                  ...
                  <div class="formRight">
                    <span class="oneTwo">
                      <textarea cols="" rows="4" _autocheck="true" id="param_meta_desc" name="meta_key"><?php echo !empty($info->meta_key) ? $info->meta_key : '' ?></textarea>
                    </span>
        ...
        if(jQuery(this).parent().parent().find('.formRight').length == 1){
          ...
          jQuery(this).parent().remove();
                 ...
                 <div class="formRow">
                	...
                	<div class="formRight">
                		<span class="oneTwo"><input type="text" _autocheck="true" id="param_sort_order" value="<?php echo !empty($info->sort_order) ? $info->sort_order : '' ?>" name="sort_order"></span>
