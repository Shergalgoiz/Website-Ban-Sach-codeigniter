...
<div class="wrapper">
      ...
      <!-- Form -->
    <form enctype="multipart/form-data" method="post" action="<?php echo admin_url('post/add')?>" id="form" class="form">
      <fieldset>
        <div class="widget">
            <div class="title">
...
<div class="formRow">
  ...
  <div class="formRight">
    <span class="oneTwo"><input type="text" value="<?php echo set_value('title'); ?>" _autocheck="true" id="param_name" name="title"></span>
      ...
      <option value=""></option>
        ...
        <?php if(count($row->sub_menu) >= 1):?>
          <optgroup label="<?php echo $row->title?>">
              ...
              <?php else:?>
                <option style="font-weight: bold" value="<?php echo $row->id?>"><?php echo $row->title?></option>
              <?php endif;?>
              <?php endforeach;?>
    </select>
