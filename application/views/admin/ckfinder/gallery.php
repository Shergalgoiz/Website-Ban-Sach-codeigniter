<html>
    <head>
        ...
        <script type="text/javascript" src="<?php echo $this->config->base_url('public/ckfinder/ckfinder.js') ?>"></script>
		<style type="text/css">
			...
			<div class="CKFinderFrameWindow">
				...
				<script type="text/javascript">
					...
					(function()
					{
						...
						config.connectorPath = '<?php echo $this->config->base_url('/admin/ckfinder/gallery/connector') ?>';
