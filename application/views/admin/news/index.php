...
<div id="main_news" class="wrapper">
	...
	<?php $this->load->view('site/message')?>
		...
		<table width="100%" cellspacing="0" cellpadding="0" id="checkAll" class="sTable mTable myTable">
			...
			<thead>
				<tr>
					<td style="width:15px;"><img src="<?php echo public_url('admin/images')?>/icons/tableArrows.png"></td>
					<td style="width:30px;">Mã số</td>
					<td>Tiêu đề</td>
					<td>Nội dung Read More</td>
					<td style="width:80px;">Ngày tạo</td>
			...
			<tbody class="list_item">
			     ...
			     <tr class="row_<?php echo $row->id?>">
					...
					<td>
						...
						<a target="_blank" title="" class="tipS" href="<?php echo base_url('tin-tuc/'.$row->slug.'.html')?>">
					...
					<td class="option textC">
						 <a title="Xem chi tiết bài viết" class="tipS" target="_blank" href="<?php echo base_url('tin-tuc/'.$row->slug.'.html')?>">
