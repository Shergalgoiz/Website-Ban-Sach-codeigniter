	        ...
	        <div class="w_cart">
	            <form action="<?php echo base_url('order/checkout')?>" method="post">
	                <div class="col1cart box_grcart">
	                    <h2 class="info-customer"> Thông tin thành viên</h2>
	                    <div class="form_gr">
                        <label for="firstname">Họ &amp; Tên <span class="required">*</span></label>
                        <input type="text" name="name" class="input-text" placeholder="" value="<?php echo isset($user->name) ? $user->name: ''?>">
	                    </div>
	                    <div class="form_gr">
	                        <label>Điện thoại <span class="required">*</span></label>
	                        <input type="text" name="phone" class="input-text" placeholder="" value="<?php echo isset($user->phone) ? $user->phone: ''?>">
	                    </div>
	                    <div class="form_gr">
	                        <label>Email đăng nhập<span class="required">*</span></label>
	                        <input type="text" name="email" class="input-text" placeholder="" value="<?php echo isset($user->email) ? $user->email: ''?>">
	                    </div>
	                    ...
	                    <div class="container_tabs">
	                        <div class="tabsradio">
	                            ...
	                            <div id="Individual_box1" class="tab-contentcart1">
	                                <div class="form_gr">
	                                    <label>Địa chỉ:</label>
	                                    <input type="text" name="address" class="input-text" placeholder="" id="firstname" value="<?php echo isset($user->address) ? $user->address: ''?>">
	                                </div>
	                                <div class="form_gr">
	                ...
	                <div class="col2cart box_grcart">
	                    ...
	                    <div class="form_gr">
	                        <label>Ghi chú</label>
	                        <textarea class="input-text" name="message" placeholder="Yêu cầu đặc biệt của bạn. Ví dụ: Giao hàng trong giờ hành chính, người nhận hàng thay,..." rows="3"></textarea>
	                    </div>
