...
<div class="header-menu">
  <div class="container">
    <div class="menu hidden-xs index" style="margin-bottom:20px;">
      <ul class="menu-header">
        ...
        <?php foreach($catalog_0 as $row):?>
          <?php if(count($row->menu_1) <= 0):?>
            <li class=""> <a href="<?php echo base_url($row->slug).'/'?>"><?php echo $row->name?></a> </li>
          <?php else:?>
            <li class="" >
      ...
      <div class="search hidden-xs">
        <form class="form-search topsearch" action="<?php echo site_url('tim-kiem')?>" method="get">
          <input type="text" aria-haspopup="true" aria-autocomplete="list" role="textbox" autocomplete="off" class="ui-autocomplete-input" name="key-search" id="text-search" class="search-input" placeholder="Nhập tên sách, tác giả..." value="">
          <button type="submit" class="btn-search" name="" id="but">
...
<div class="admin show">
  <span class="fix">
    <a href="<?php echo base_url('admin/dang-nhap') ?>" class="fa fa-cog fa-spin fa-3x fa-fw" title="Trang quản trị"></a>
  </span>
</div><!-- /admin -->
