<?php
	...
	class BaoKim_payment{
		...
		var $code 		= 'baokim';
		var $setting 	= array(
			'business' 				=> '',//tai khoan cua nguoi nhan tien
			'merchant_id' 			=> '',//id cua website khi dang ky ben baokim
		...
		//var $url 		= 'https://www.baokim.vn/payment/order/version11';	// URL chay that
		...
		);	//những IP baokim gửi dữ liệu về
