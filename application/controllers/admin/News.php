<?php
    Class News extends MY_Controller
    {
        ...
        function _check_slug(){
            ...
            $info = $this->news_model->get_info($this->uri->rsegment(3));
            if($this->uri->rsegment('3')){
               $conditional = $this->news_model->get_list(array('where'=>array('slug !=' =>$info->slug,'slug'=>$slug)));
            }
            else{
                $conditional = $this->news_model->get_list(array('where'=>array('slug'=>$slug)));
            }
            if($conditional){
